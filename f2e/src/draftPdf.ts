...
export function draftPdfDefinition(): TDocumentDefinitions {
  ...
  return {
    ...
    info: { title: '113-16 訴願決定書草稿', author: '新北市政府法制局' },
    content: [
      { columns: [
      ...
      { text: '案號：113-16', alignment: 'center', fontSize: 9, color: '#8991a0', margin: [0, 0, 0, 20] },
      { table: { widths: [74, '*'], body: [
        ['訴願人', '王小明'], ['原處分機關', '新北市政府警察局新店分局'], ['案由', '違反洗錢防制法事件'],
