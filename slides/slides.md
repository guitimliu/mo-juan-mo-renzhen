...
<div class="foot"><span>EC2 Docker Compose（Vue＋FastAPI）→ Bedrock Converse（Sonnet 5，降級 4.6）＋ Knowledge Base（Titan v2＋S3 Vectors）｜us-west-2</span><span>08 / 10</span></div>
